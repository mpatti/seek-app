...
Respond ONLY with a comma-separated list of verse references. Nothing else.`;
      ...
      const answerPrompt = `You are a thoughtful Christian pastor who believes the Bible is true and speaks with conviction. You're having a real conversation about this Bible passage: ${passageRef}

The passage says: "${passageText.replace(/<[^>]*>/g, '').substring(0, 500)}..."

The user asks: "${message}"

Answer their question with conviction - not relativism. Be conversational, concise, 1-2 sentences. No quotes.`;
